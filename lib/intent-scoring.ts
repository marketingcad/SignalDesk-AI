...
const POSITIVE_SIGNALS: WeightedKeyword[] = [
  ...
  { phrase: "urgent va hire", weight: 20, category: "Direct Hiring" },
  { phrase: "urgently need a va", weight: 20, category: "Direct Hiring" },
  { phrase: "need a va asap", weight: 20, category: "Direct Hiring" },
  ...
  { phrase: "is it worth hiring a va", weight: 20, category: "Recommendation Request" },
